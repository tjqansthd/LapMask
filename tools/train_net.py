...
from detectron2.solver.build import get_default_optimizer_params, maybe_add_gradient_clipping, build_optimizer
...
class Trainer(DefaultTrainer):
    ...
    def build_optimizer(cls, cfg, model):
        ...
        if cfg.SOLVER.OPTIMIZER == 'ADAM':
            return build_optimizer_AdamW(cfg, model)
        else:
